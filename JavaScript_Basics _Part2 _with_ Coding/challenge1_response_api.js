...
// As an SDET, you receive an API response status code and need 
// to classify it. Write a JavaScript program using a 
// switch statement that takes an HTTP status code stored 
